...
##Add 2 themes for papaya and appflood

Just add two css files for the themes which are specially for friends working for PapayaMobile and AppFlood.
Apply those themes by just modify the index.html
to
```html
